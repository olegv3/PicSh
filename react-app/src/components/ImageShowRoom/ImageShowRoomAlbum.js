                        ...
                        <div className="image-container-showroom">
                            <div>
                                <Link to={`/people/${userId}/albums/${albumId}`} className="back-to-explore-link-div">
                                    ...
                                    <span className="back-to-explore-link">Back to all Albums</span>
                                </Link>
                            </div>
                            <div className="showroom-image-div">
                                <img className="showroom-image" src={currentImage?.url} onError={e => e.target.src = "https://www.theoxygenstore.com/images/source/No-image.jpg"} />
                            </div>
